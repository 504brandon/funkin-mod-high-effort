...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'fatal-sonic':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('fatal-error-sonic','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'Fatal sonic idle', 24);
				animation.addByPrefix('singUP', 'Fatal sonic up', 24);
				animation.addByPrefix('singRIGHT', 'Fatal sonic right', 24);
				animation.addByPrefix('singDOWN', 'Fatal sonic down', 24);
				animation.addByPrefix('singLEFT', 'Fatal sonic left', 24);
			...
			case 'bf-pixel-dead':
				...
				case 'bf-fatal':
					var tex = Paths.getSparrowAtlas('fatal-bf','shared',true);
					frames = tex;
