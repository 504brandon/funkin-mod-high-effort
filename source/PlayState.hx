			...
			switch (stageCheck)
			{
				...
				case 'schoolEvil':
					...
					case 'tank':
						...
						var smokeL:BGSprite = new BGSprite('smokeLeft', -200, -100, 0.4, 0.4, ['SmokeBlurLeft instance 1'], true);
						add(smokeL);
						
						var smokeR:BGSprite = new BGSprite('smokeRight', 1100, -100, 0.4, 0.4, ['SmokeRight instance 1'], true);
						add(smokeR);
						...
						var tankdude0:BGSprite = new BGSprite('tank0', -500, 650, 1.7, 1.5, ['fg tankhead far right instance 1']);
						add(tankdude0);
						
						var tankdude1:BGSprite = new BGSprite('tank1', -300, 750, 2, 0.2, ['fg tankhead 5 instance 1']);
						add(tankdude1);
						
						var tankdude2:BGSprite = new BGSprite('tank2', 450, 940, 1.5, 1.5, ['foreground man 3 instance 1']);
						add(tankdude2);
						
						var tankdude4:BGSprite = new BGSprite('tank4', 1300, 900, 1.5, 1.5, ['fg tankhead 4 instance 1']);
						add(tankdude4);
						
						var tankdude5:BGSprite = new BGSprite('tank5', 1620, 700, 1.5, 1.5, ['fg tankman bobbin 3 instance 1']);
						add(tankdude5);
						
						var tankdude3:BGSprite = new BGSprite('tank3', 1300, 1200, 3.5, 2.5, ['fg tankhead far right instance 1']);
						add(tankdude3);
	...
	override function beatHit()
	{
		...
		switch (curStage)
		{
			...
			case "tank":
				if (FlxG.save.data.distractions)
					{
					tankdude0.animation.play('idle', true);
					tankdude1.animation.play('idle', true);
					tankdude2.animation.play('idle', true);
					tankdude3.animation.play('idle', true);
					tankdude4.animation.play('idle', true);
					tankdude5.animation.play('idle', true);
					tankWatchtower.animation.play('idle', true);
					smokeL.animation.play('idle', true);
					smokeR.animation.play('idle', true);
					//WHAT DA HELLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
					}
